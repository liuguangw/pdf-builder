...
export default function loadBookMetaInfo(bookInfo: BookInfo): BookMetaInfo {
  const metaInfo: BookMetaInfo = {
    ...
    headerTpl:
      '<div style="border-bottom: 1px solid #eee;color: #5c6163;padding: 8px 0;position:relative;font-size:14px;height:20px;line-height:20px;">' +
      ...
      '</div>',
    footerTpl:
      '<div style="border-top: 1px solid #eee;color: #5c6163;padding: 8px 0;position:relative;font-size:14px;height:20px;line-height:20px;">' +
